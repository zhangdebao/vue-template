...
<head>
    <title>Code coverage report for vue-template/dist/webpack:/node_modules/vue-router/dist/vue-router.esm.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../../../index.html">All files</a> / <a href="index.html">vue-template/dist/webpack:/node_modules/vue-router/dist</a> vue-router.esm.js</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">0% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>0/796</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>0/844</span>
            </div>
...
<a name='L3017'></a><a href='#L3017'>3017</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >function <span class="fstat-no" title="function not covered" >i</span>sError (e</span>rr) {
<span class="cstat-no" title="statement not covered" >  return Object.prototype.toString.call(err).indexOf('Error') &gt; -1</span>
}
&nbsp;
function <span class="fstat-no" title="function not covered" >isRouterError (e</span>rr, errorType) {
<span class="cstat-no" title="statement not covered" >  return isError(err) &amp;&amp; err._isRouter &amp;&amp; (errorType == null || err.type === errorType)</span>
}
&nbsp;
function <span class="fstat-no" title="function not covered" >extend (a</span>, b) {
...
&nbsp;
var View = <span class="cstat-no" title="statement not covered" >{</span>
  name: 'RouterView',
  functional: true,
  props: {
    name: {
  ...
  render: <span class="fstat-no" title="function not covered" >function render (_</span>, ref) {
    var props = <span class="cstat-no" title="statement not covered" >ref.props;</span>
    var children = <span class="cstat-no" title="statement not covered" >ref.children;</span>
    var parent = <span class="cstat-no" title="statement not covered" >ref.parent;</span>
    var data = <span class="cstat-no" title="statement not covered" >ref.data;</span>
&nbsp;
...
&nbsp;
    ...
    var h = <span class="cstat-no" title="statement not covered" >parent.$createElement;</span>
    var name = <span class="cstat-no" title="statement not covered" >props.name;</span>
    var route = <span class="cstat-no" title="statement not covered" >parent.$route;</span>
    var cache = <span class="cstat-no" title="statement not covered" >parent._routerViewCache || (parent._routerViewCache = {});</span>
&nbsp;
    // determine current view depth, also check to see if the tree
    // has been toggled inactive but kept-alive.
    var depth = <span class="cstat-no" title="statement not covered" >0;</span>
    var <span class="cstat-no" title="statement not covered" >inactive = false;</span>
<span class="cstat-no" title="statement not covered" >    while (parent &amp;&amp; parent._routerRoot !== parent) {</span>
      var vnodeData = <span class="cstat-no" title="statement not covered" >parent.$vnode ? parent.$vnode.data : {};</span>
      if (<span class="cstat-no" title="statement not covered" >vnodeData.routerView) {</span>
        depth++;
      }
...
<span class="cstat-no" title="statement not covered" >    if (inactive) {</span>
      var cachedData = <span class="cstat-no" title="statement not covered" >cache[name];</span>
      var cachedComponent = <span class="cstat-no" title="statement not covered" >cachedData &amp;&amp; cachedData.component;</span>
<span class="cstat-no" title="statement not covered" >      if (cachedComponent) {</span>
        // #2301
        // pass props
...
&nbsp;
    var matched = <span class="cstat-no" title="statement not covered" >route.matched[depth];</span>
    var component = <span class="cstat-no" title="statement not covered" >matched &amp;&amp; matched.components[name];</span>
&nbsp;
    // render empty node if no matched route or no config component
<span class="cstat-no" title="statement not covered" >    if (!matched || !component) {</span>
      cache[name] = null;
<span class="cstat-no" title="statement not covered" >      return h()</span>
    }
&nbsp;
    // cache component
<span class="cstat-no" title="statement not covered" >    cache[name] = { component: component };</span>
&nbsp;
    // attach instance registration hook
    // this will be called in the instance's injected lifecycle hooks
    data.registerRouteInstance = <span class="fstat-no" title="function not covered" >function (v</span>m, val) {
      // val could be undefined for unregistration
      var current = <span class="cstat-no" title="statement not covered" >matched.instances[<span class="cstat-no" title="statement not covered" >name];</span></span>
      if (
        (val &amp;&amp; current !== vm) ||
        (!val &amp;&amp; current === vm)
      ) {
...
&nbsp;
    ...
    ;(data.hook || (data.hook = {})).prepatch = <span class="fstat-no" title="function not covered" >function (_</span>, vnode) {
<span class="cstat-no" title="statement not covered" >      matched.instances[name] = vnode.componentInstance;</span>
    };
&nbsp;
    // register instance in init hook
    // in case kept-alive component be actived when routes changed
    data.hook.init = <span class="fstat-no" title="function not covered" >function (v</span>node) {
      if (<span class="cstat-no" title="statement not covered" >vnode.data.keepAlive &amp;&amp;</span>
...
&nbsp;
    var configProps = <span class="cstat-no" title="statement not covered" >matched.props &amp;&amp; matched.props[name];</span>
...
&nbsp;
function <span class="fstat-no" title="function not covered" >fillPropsinData (c</span>omponent, data, route, configProps) {
  // resolve props
  var propsToPass = <span class="cstat-no" title="statement not covered" >data.props = resolveProps(route, configProps);</span>
<span class="cstat-no" title="statement not covered" >  if (propsToPass) {</span>
    // clone to prevent mutation
<span class="cstat-no" title="statement not covered" >    propsToPass = data.props = extend({}, propsToPass);</span>
    // pass non-declared props as attrs
    var attrs = <span class="cstat-no" title="statement not covered" >data.attrs = data.attrs || {};</span>
<span class="cstat-no" title="statement not covered" >    for (var key in propsToPass) {</span>
      if (!<span class="cstat-no" title="statement not covered" >component.props || !(key in component.props)) {</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >function resolveProps (r</span>oute, config) {
<span class="cstat-no" title="statement not covered" >  switch (typeof config) {</span>
    case 'undefined':
<span class="cstat-no" title="statement not covered" >      return</span>
    case 'object':
<span class="cstat-no" title="statement not covered" >      return config</span>
    case 'function':
<span class="cstat-no" title="statement not covered" >      return config(route)</span>
    case 'boolean':
<span class="cstat-no" title="statement not covered" >      return config ? route.params : undefined</span>
    default:
      if (<span class="cstat-no" title="statement not covered" >process.env.NODE_ENV !== 'production') {</span>
        warn(
          false,
...
/*  */
&nbsp;
var encodeReserveRE = <span class="cstat-no" title="statement not covered" >/[!'()*]/g;</span>
var encodeReserveReplacer = <span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >function (c</span>) { <span class="cstat-no" title="statement not covered" >return '%' + c.charCodeAt(0).toString(16); };</span></span>
var commaRE = <span class="cstat-no" title="statement not covered" >/%2C/g;</span>
&nbsp;
// fixed encodeURIComponent which is more conformant to RFC3986:
// - escapes [!'()*]
// - preserve commas
var encode = <span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >function (s</span>tr) { <span class="cstat-no" title="statement not covered" >return encodeURIComponent(str)</span></span>
  .replace(encodeReserveRE, encodeReserveReplacer)
  .replace(commaRE, ','); };
&nbsp;
var decode = <span class="cstat-no" title="statement not covered" >decodeURIComponent;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >function resolveQuery (</span></span>
  query,
  extraQuery,
<span class="cstat-no" title="statement not covered" >  _parseQuery</span>
) {
  if ( extraQuery === void 0 ) extraQuery = {};
&nbsp;
  var parse = <span class="cstat-no" title="statement not covered" >_parseQuery || parseQuery;</span>
  var parsedQuery;
<span class="cstat-no" title="statement not covered" >  try {</span>
<span class="cstat-no" title="statement not covered" >    parsedQuery = parse(query || '');</span>
  } catch (e) {
    process.env.NODE_ENV !== 'production' &amp;&amp; warn(false, e.message);
<span class="cstat-no" title="statement not covered" >    parsedQuery = {};</span>
  }
<span class="cstat-no" title="statement not covered" >  for (var key in extraQuery) {</span>
<span class="cstat-no" title="statement not covered" >    parsedQuery[key] = extraQuery[key];</span>
  }
<span class="cstat-no" title="statement not covered" >  return parsedQuery</span>
}
&nbsp;
function <span class="fstat-no" title="function not covered" >parseQuery (q</span>uery) {
...
&nbsp;
  query.split('&amp;').forEach(<span class="fstat-no" title="function not covered" >function (p</span>aram) {
    var parts = <span class="cstat-no" title="statement not covered" >param.replace(/\+/g, ' ').split('=');</span>
    var key = <span class="cstat-no" title="statement not covered" >decode(parts.shift());</span>
    var val = <span class="cstat-no" title="statement not covered" >parts.length &gt; 0</span>
      ? decode(parts.join('='))
...
&nbsp;
function <span class="fstat-no" title="function not covered" >stringifyQuery (o</span>bj) {
  var res = <span class="cstat-no" title="statement not covered" >obj ? Object.keys(obj).map(<span class="fstat-no" title="function not covered" >function (k</span>ey) {</span>
    var val = <span class="cstat-no" title="statement not covered" >obj[key];</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      return encode(key)</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (Array.isArray(val)) {</span>
      ...
      val.forEach(<span class="fstat-no" title="function not covered" >function (<span class="cstat-no" title="statement not covered" >v</span>al2) {</span>
        if (val2 === undefined) {
          return
        }
        if (val2 === null) {
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    return encode(key) + '=' + encode(val)</span>
  }).filter(<span class="fstat-no" title="function not covered" >function (x</span>) { <span class="cstat-no" title="statement not covered" >return x.length &gt; 0; }).j</span>oin('&amp;') : null;
<span class="cstat-no" title="statement not covered" >  return res ? ("?" + res) : ''</span>
}
&nbsp;
/*  */
&nbsp;
var trailingSlashRE = <span class="cstat-no" title="statement not covered" >/\/?$/;</span>
&nbsp;
function <span class="fstat-no" title="function not covered" >createRoute (</span>
  record,
  location,
  redirectedFrom,
  router
) {
  var stringifyQuery = <span class="cstat-no" title="statement not covered" >router &amp;&amp; router.options.stringifyQuery;</span>
&nbsp;
  var query = <span class="cstat-no" title="statement not covered" >location.query || {};</span>
<span class="cstat-no" title="statement not covered" >  try {</span>
<span class="cstat-no" title="statement not covered" >    query = clone(query);</span>
  } catch (e) {}
&nbsp;
  var route = <span class="cstat-no" title="statement not covered" >{</span>
...
<span class="cstat-no" title="statement not covered" >  return Object.freeze(route)</span>
}
&nbsp;
function <span class="fstat-no" title="function not covered" >clone (v</span>alue) {
<span class="cstat-no" title="statement not covered" >  if (Array.isArray(value)) {</span>
<span class="cstat-no" title="statement not covered" >    return value.map(clone)</span>
...
<span class="cstat-no" title="statement not covered" >      res[key] = clone(value[key]);</span>
    }
...
var START = <span class="cstat-no" title="statement not covered" >createRoute(null, {</span>
  path: '/'
});
&nbsp;
function <span class="fstat-no" title="function not covered" >formatMatch (r</span>ecord) {
  var res = <span class="cstat-no" title="statement not covered" >[];</span>
<span class="cstat-no" title="statement not covered" >  while (record) {</span>
<span class="cstat-no" title="statement not covered" >    res.unshift(record);</span>
    record = record.parent;
  }
<span class="cstat-no" title="statement not covered" >  return res</span>
}
&nbsp;
function <span class="fstat-no" title="function not covered" >getFullPath (</span>
  ref,
  _stringifyQuery
) {
  var path = <span class="cstat-no" title="statement not covered" >ref.path;</span>
  var query = <span class="cstat-no" title="statement not covered" >ref.<span class="cstat-no" title="statement not covered" >query; if ( q</span>uery === void 0 ) query = {};</span>
  var hash = <span class="cstat-no" title="statement not covered" >ref.hash; if ( h</span>ash === void 0 ) hash = '';
&nbsp;
  var stringify = _stringifyQuery || stringifyQuery;
<span class="cstat-no" title="statement not covered" >  return (path || '/') + stringify(query) + hash</span>
}
&nbsp;
function <span class="fstat-no" title="function not covered" >isSameRoute (a</span>, b) {
<span class="cstat-no" title="statement not covered" >  if (b === START) {</span>
    return a === b
  } else if (!b) {
    return false
...
&nbsp;
function <span class="fstat-no" title="function not covered" >isObjectEqual (a</span>, b) {
  if ( a === void 0 ) a = {};
  if ( b === void 0 ) b = {};
&nbsp;
  // handle null value #1566
<span class="cstat-no" title="statement not covered" >  if (!a || !b) { <span class="cstat-no" title="statement not covered" >return a === b }</span></span>
  var aKeys = <span class="cstat-no" title="statement not covered" >Object.keys(a);</span>
  var bKeys = <span class="cstat-no" title="statement not covered" >Object.keys(b);</span>
<span class="cstat-no" title="statement not covered" >  if (aKeys.length !== bKeys.length) {</span>
    return false
  }
  return aKeys.every(<span class="fstat-no" title="function not covered" >function (k</span>ey) {
    var aVal = <span class="cstat-no" title="statement not covered" >a[key];</span>
    var bVal = <span class="cstat-no" title="statement not covered" >b[key];</span>
    // check nested equality
<span class="cstat-no" title="statement not covered" >    if (typeof aVal === 'object' &amp;&amp; typeof bVal === 'object') {</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >function isIncludedRoute (c</span>urrent, target) {
<span class="cstat-no" title="statement not covered" >  return (</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >function queryIncludes (c</span>urrent, target) {
<span class="cstat-no" title="statement not covered" >  for (var key in target) {</span>
<span class="cstat-no" title="statement not covered" >    if (!(key in current)) {</span>
...
/*  */
&nbsp;
function <span class="fstat-no" title="function not covered" >resolvePath (</span>
  relative,
  base,
  append
) {
  var firstChar = <span class="cstat-no" title="statement not covered" >relative.charAt(0);</span>
...
<span class="cstat-no" title="statement not covered" >    return base + relative</span>
  }
&nbsp;
  var stack = <span class="cstat-no" title="statement not covered" >base.split('/');</span>
&nbsp;
  // remove trailing segment if:
  // - not appending
  // - appending to trailing slash (last segment is empty)
  if (!<span class="cstat-no" title="statement not covered" >append || !stack[stack.length - 1]) {</span>
    stack.pop();
  }
&nbsp;
  // resolve relative path
  var segments = <span class="cstat-no" title="statement not covered" >relative.replace(/^\//, '').split('/');</span>
<span class="cstat-no" title="statement not covered" >  for (var i = <span class="cstat-no" title="statement not covered" >0; i</span> &lt; segments.length; i++) {</span>
    var segment = <span class="cstat-no" title="statement not covered" >segments[i];</span>
    if (segment === <span class="cstat-no" title="statement not covered" >'..') {</span>
      stack.pop();
    } else if (segment !== '.') {
      stack.push(segment);
    }
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  return stack.join('/')</span>
}
&nbsp;
<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >function parsePath (p</span>ath) {</span>
  var hash = <span class="cstat-no" title="statement not covered" >'';</span>
  var query = <span class="cstat-no" title="statement not covered" >'';</span>
&nbsp;
  var hashIndex = <span class="cstat-no" title="statement not covered" >path.indexOf('#');</span>
  if (<span class="cstat-no" title="statement not covered" >hashIndex &gt;= 0) {</span>
    hash = path.slice(hashIndex);
    path = path.slice(0, hashIndex);
  }
&nbsp;
  var queryIndex = <span class="cstat-no" title="statement not covered" >path.indexOf('?');</span>
  if (queryIndex &gt;= 0) {
...
&nbsp;
function <span class="fstat-no" title="function not covered" >cleanPath (p</span>ath) {
<span class="cstat-no" title="statement not covered" >  return path.replace(/\/\//g, '/')</span>
}
&nbsp;
var isarray = <span class="cstat-no" title="statement not covered" >Array.isArray || <span class="fstat-no" title="function not covered" >function (a</span>rr) {</span>
<span class="cstat-no" title="statement not covered" >  return Object.prototype.toString.call(arr) == '</span>[object Array]';
};
&nbsp;
/**
 * Expose `pathToRegexp`.
 */
var pathToRegexp_1 = <span class="cstat-no" title="statement not covered" >pathToRegexp;</span>
var parse_1 = <span class="cstat-no" title="statement not covered" >parse;</span>
var compile_1 = compile;
var tokensToFunction_1 = <span class="cstat-no" title="statement not covered" >tokensToFunction;</span>
var tokensToRegExp_1 = <span class="cstat-no" title="statement not covered" >tokensToRegExp;</span>
&nbsp;
/**
 ...
 * @type {RegExp}
 */
var PATH_REGEXP = <span class="cstat-no" title="statement not covered" >new RegExp([</span>
 ...
 * @return {!Array}
 */
function <span class="fstat-no" title="function not covered" >parse (s</span>tr, options) {
  var tokens = <span class="cstat-no" title="statement not covered" >[];</span>
  var key = <span class="cstat-no" title="statement not covered" >0;</span>
  var index = <span class="cstat-no" title="statement not covered" >0;</span>
  var path = <span class="cstat-no" title="statement not covered" >'';</span>
  var defaultDelimiter = <span class="cstat-no" title="statement not covered" >options &amp;&amp; options.delimiter || '/';</span>
  var res;
&nbsp;
<span class="cstat-no" title="statement not covered" >  while ((res = PATH_REGEXP.exec(str)) != null) {</span>
    var m = <span class="cstat-no" title="statement not covered" >res[0];</span>
    var escaped = <span class="cstat-no" title="statement not covered" >res[1];</span>
    var offset = <span class="cstat-no" title="statement not covered" >res.index;</span>
...
&nbsp;
    var next = <span class="cstat-no" title="statement not covered" >str[index];</span>
    var prefix = <span class="cstat-no" title="statement not covered" >res[2];</span>
    var name = <span class="cstat-no" title="statement not covered" >res[3];</span>
    var capture = <span class="cstat-no" title="statement not covered" >res[4];</span>
    var group = <span class="cstat-no" title="statement not covered" >res[5];</span>
    var modifier = <span class="cstat-no" title="statement not covered" >res[6];</span>
    var asterisk = <span class="cstat-no" title="statement not covered" >res[7];</span>
&nbsp;
    // Push the current path onto the tokens.
    if (<span class="cstat-no" title="statement not covered" >path) {</span>
      tokens.push(path);
      path = '';
    }
&nbsp;
    var partial = prefix != <span class="cstat-no" title="statement not covered" >null &amp;&amp; next != null &amp;&amp; next !== prefix;</span>
    var repeat = modifier === <span class="cstat-no" title="statement not covered" >'+' || modifier === '</span>*';
    var optional = modifier === <span class="cstat-no" title="statement not covered" >'?' || modifier === '</span>*';
    var delimiter = <span class="cstat-no" title="statement not covered" >res[2] || defaultDelimiter;</span>
    var pattern = <span class="cstat-no" title="statement not covered" >capture || group;</span>
&nbsp;
 ...
 */
<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >function compile (s</span>tr, options) {</span>
<span class="cstat-no" title="statement not covered" >  return tokensToFunction(parse(str, options), options)</span>
}
&nbsp;
/**
 ...
 * @return {string}
 */
function <span class="fstat-no" title="function not covered" >encodeURIComponentPretty (s</span>tr) {
...
function encodeAsterisk (str) {
  return encodeURI(str).replace(/[?#]/g, <span class="fstat-no" title="function not covered" >function (c</span>) {
<span class="cstat-no" title="statement not covered" >    return '%' + c.charCodeAt(0).toString(16).toUpperCase()</span>
  })
}
&nbsp;
 ...
 */
function <span class="fstat-no" title="function not covered" >tokensToFunction (t</span>okens, options) {
  // Compile all the tokens into regexps.
  var matches = <span class="cstat-no" title="statement not covered" >new Array(tokens.length);</span>
&nbsp;
  // Compile all the patterns before compilation.
<span class="cstat-no" title="statement not covered" >  for (var i = <span class="cstat-no" title="statement not covered" >0; i</span> &lt; tokens.length; i++) {</span>
    if (typeof tokens[i] === <span class="cstat-no" title="statement not covered" >'object') {</span>
      matches[i] = new RegExp('^(?:' + tokens[i].pattern + ')$', flags(options));
    }
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  return <span class="fstat-no" title="function not covered" >function (o</span>bj, opts) {</span>
    var path = <span class="cstat-no" title="statement not covered" >'';</span>
    var data = <span class="cstat-no" title="statement not covered" >obj || {};</span>
    var options = opts || {};
    var <span class="cstat-no" title="statement not covered" >encode = options.pretty ? encodeURIComponentPretty : encodeURIComponent;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    for (var i = <span class="cstat-no" title="statement not covered" >0; i</span> &lt; tokens.length; i++) {</span>
      var token = <span class="cstat-no" title="statement not covered" >tokens[i];</span>
&nbsp;
...
&nbsp;
      var value = <span class="cstat-no" title="statement not covered" >data[token.name];</span>
      var segment;
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        if (token.optional) {</span>
          ...
          if (<span class="cstat-no" title="statement not covered" >token.partial) {</span>
            path += token.prefix;
          }
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        for (var j = <span class="cstat-no" title="statement not covered" >0; j</span> &lt; value.length; j++) {</span>
 ...
 * @return {string}
 */
function <span class="fstat-no" title="function not covered" >escapeString (s</span>tr) {
 ...
 * @return {string}
 */
function <span class="fstat-no" title="function not covered" >escapeGroup (g</span>roup) {
 ...
 * @return {!RegExp}
 */
function <span class="fstat-no" title="function not covered" >attachKeys (r</span>e, keys) {
  re.keys = keys;
 ...
 * @return {string}
 */
function <span class="fstat-no" title="function not covered" >flags (o</span>ptions) {
<span class="cstat-no" title="statement not covered" >  return options &amp;&amp; options.sensitive ? '' : 'i'</span>
}
&nbsp;
/**
 ...
 * @return {!RegExp}
 */
<span class="fstat-no" title="function not covered" >function regexpToRegexp (p</span>ath, keys) {
  // Use a negative lookahead to match only capturing groups.
  var groups = <span class="cstat-no" title="statement not covered" >path.source.match(/\((?!\?)/g);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (groups) {</span>
<span class="cstat-no" title="statement not covered" >    for (var i = <span class="cstat-no" title="statement not covered" >0; i</span> &lt; groups.length; i++) {</span>
 ...
 * @return {!RegExp}
 */
<span class="fstat-no" title="function not covered" >function arrayToRegexp (p</span>ath, keys, options) {
  var parts = <span class="cstat-no" title="statement not covered" >[];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  for (var i = <span class="cstat-no" title="statement not covered" >0; i</span> &lt; path.length; i++) {</span>
 ...
 * @return {!RegExp}
 */
<span class="fstat-no" title="function not covered" >function stringToRegexp (p</span>ath, keys, options) {
 ...
 * @return {!RegExp}
 */
function <span class="fstat-no" title="function not covered" >tokensToRegExp (t</span>okens, keys, options) {
  if (!<span class="cstat-no" title="statement not covered" >isarray(keys)) {</span>
...
&nbsp;
  options = options || {};
&nbsp;
  var <span class="cstat-no" title="statement not covered" >strict = options.strict;</span>
  var <span class="cstat-no" title="statement not covered" >end = options.end !== f</span>alse;
  var route = <span class="cstat-no" title="statement not covered" >'';</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      route += escapeString(token);</span>
      ...
      var prefix = <span class="cstat-no" title="statement not covered" >escapeString(token.prefix);</span>
      var capture = <span class="cstat-no" title="statement not covered" >'(?:' + token.pattern + ')';</span>
&nbsp;
...
&nbsp;
  var delimiter = <span class="cstat-no" title="statement not covered" >escapeString(options.delimiter || '/');</span>
  var endsWithDelimiter = <span class="cstat-no" title="statement not covered" >route.slice(-delimiter.length) === delimiter;</span>
&nbsp;
 ...
 * @return {!RegExp}
 */
function <span class="fstat-no" title="function not covered" >pathToRegexp (p</span>ath, keys, options) {
  if (!isarray(keys)) {
    options = /** @type {!Object} */ (keys || options);
    keys = [];
  }
...
<span class="cstat-no" title="statement not covered" >pathToRegexp_1.parse = parse_1;</span>
...
&nbsp;
// $flow-disable-line
var regexpCompileCache = <span class="cstat-no" title="statement not covered" >Object.create(null);</span>
&nbsp;
function <span class="fstat-no" title="function not covered" >fillParams (</span>
  path,
  params,
  routeMsg
) {
...
<span class="cstat-no" title="statement not covered" >  try {</span>
    var filler =
<span class="cstat-no" title="statement not covered" >      regexpCompileCache[path] ||</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    return filler(params, { pretty: true })</span>
  } catch (e) {
...
/*  */
&nbsp;
function <span class="fstat-no" title="function not covered" >normalizeLocation (</span>
  raw,
  current,
  append,
  router
) {
  var next = typeof raw === <span class="cstat-no" title="statement not covered" >'string' ? { path: raw } : raw;</span>
  // named target
<span class="cstat-no" title="statement not covered" >  if (next._normalized) {</span>
<span class="cstat-no" title="statement not covered" >    return next</span>
  } else <span class="cstat-no" title="statement not covered" >if (next.name) {</span>
    next = extend({}, raw);
    var <span class="cstat-no" title="statement not covered" >params = next.params;</span>
...
&nbsp;
  // relative params
<span class="cstat-no" title="statement not covered" >  if (!next.path &amp;&amp; next.params &amp;&amp; current) <span class="cstat-no" title="statement not covered" >{</span></span>
    next = extend({}, next);
    next._normalized = true;
    var params$1 = <span class="cstat-no" title="statement not covered" >extend(extend({}, current.params), next.params);</span>
<span class="cstat-no" title="statement not covered" >    if (current.name) {</span>
<span class="cstat-no" title="statement not covered" >      next.name = current.name;</span>
      next.params = params$1;
    } else <span class="cstat-no" title="statement not covered" >if (current.matched.length) {</span>
      var rawPath = <span class="cstat-no" title="statement not covered" >current.matched[current.matched.length - 1].path;</span>
<span class="cstat-no" title="statement not covered" >      next.path = fillParams(rawPath, params$1, ("path " + (current.path)));</span>
    } else if (<span class="cstat-no" title="statement not covered" >process.env.NODE_ENV !== 'production') {</span>
...
&nbsp;
  ...
  var basePath = (<span class="cstat-no" title="statement not covered" >current &amp;&amp; current.path) || '/';</span>
  var path = <span class="cstat-no" title="statement not covered" >parsedPath.path</span>
...
&nbsp;
  var hash = <span class="cstat-no" title="statement not covered" >next.hash || parsedPath.hash;</span>
...
&nbsp;
var noop = <span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >function () {};</span></span>
&nbsp;
var Link = <span class="cstat-no" title="statement not covered" >{</span>
  name: 'RouterLink',
  props: {
    to: {
      type: toTypes,
  ...
  render: <span class="fstat-no" title="function not covered" >function render (h</span>) {
    var this$1 = <span class="cstat-no" title="statement not covered" >this;</span>
&nbsp;
    var router = <span class="cstat-no" title="statement not covered" >this.$router;</span>
    var current = <span class="cstat-no" title="statement not covered" >this.$route;</span>
    var ref = <span class="cstat-no" title="statement not covered" >router.resolve(</span>
      this.to,
      current,
      this.append
    );
    var location = <span class="cstat-no" title="statement not covered" >ref.location;</span>
    var route = <span class="cstat-no" title="statement not covered" >ref.route;</span>
    var href = <span class="cstat-no" title="statement not covered" >ref.href;</span>
&nbsp;
    var classes = <span class="cstat-no" title="statement not covered" >{};</span>
    var globalActiveClass = <span class="cstat-no" title="statement not covered" >router.options.linkActiveClass;</span>
    var globalExactActiveClass = <span class="cstat-no" title="statement not covered" >router.options.linkExactActiveClass;</span>
    // Support global empty active class
    var activeClassFallback =
      globalActiveClass == <span class="cstat-no" title="statement not covered" >null ? 'router-link-active' : globalActiveClass;</span>
    var exactActiveClassFallback =
      globalExactActiveClass == <span class="cstat-no" title="statement not covered" >null</span>
        ? 'router-link-exact-active'
        : globalExactActiveClass;
    var activeClass =
      this.activeClass == <span class="cstat-no" title="statement not covered" >null ? activeClassFallback : this.activeClass;</span>
    var exactActiveClass =
      this.exactActiveClass == <span class="cstat-no" title="statement not covered" >null</span>
        ? exactActiveClassFallback
        : this.exactActiveClass;
&nbsp;
    var compareTarget = <span class="cstat-no" title="statement not covered" >route.redirectedFrom</span>
      ? createRoute(null, normalizeLocation(route.redirectedFrom), null, router)
      : route;
&nbsp;
<span class="cstat-no" title="statement not covered" >    classes[exactActiveClass] = isSameRoute(current, compareTarget);</span>
    classes[activeClass] = this.exact
      ? classes[exactActiveClass]
      : isIncludedRoute(current, compareTarget);
&nbsp;
    var ariaCurrentValue = <span class="cstat-no" title="statement not covered" >classes[exactActiveClass] ? this.ariaCurrentValue : null;</span>
&nbsp;
    var handler = <span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >function (e</span>) {</span>
      if (<span class="cstat-no" title="statement not covered" >guardEvent(e)) {</span>
        if (this$1.replace) {
...
&nbsp;
    var on = <span class="cstat-no" title="statement not covered" >{ click: guardEvent };</span>
    if (<span class="cstat-no" title="statement not covered" >Array.isArray(this.event)) {</span>
      this.event.forEach(<span class="fstat-no" title="function not covered" >function (e</span>) {
<span class="cstat-no" title="statement not covered" >        on[e] = handler;</span>
      });
    } else {
      on[this.event] = handler;
    }
&nbsp;
    var data = <span class="cstat-no" title="statement not covered" >{ class: classes };</span>
&nbsp;
    var <span class="cstat-no" title="statement not covered" >scopedSlot =</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (scopedSlot) {</span>
<span class="cstat-no" title="statement not covered" >      if (scopedSlot.length === 1) {</span>
<span class="cstat-no" title="statement not covered" >        return scopedSlot[0]</span>
      } else <span class="cstat-no" title="statement not covered" >if (scopedSlot.length &gt; 1 || !scopedSlot.length) {</span>
        if (process.env.NODE_ENV !== 'production') {
          warn(
            false,
...
<span class="cstat-no" title="statement not covered" >        return scopedSlot.length === 0 ? h() : h('span', {}, scopedSlot)</span>
      }
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (this.tag === 'a') {</span>
<span class="cstat-no" title="statement not covered" >      data.on = on;</span>
...
<span class="cstat-no" title="statement not covered" >        a.isStatic = false;</span>
        var aData = (<span class="cstat-no" title="statement not covered" >a.data = extend({}, a.data));</span>
        aData.on = aData.on || {};
        // transform existing events in both objects into arrays so we can push later
<span class="cstat-no" title="statement not covered" >        for (var event in aData.on) {</span>
          var handler$1 = <span class="cstat-no" title="statement not covered" >aData.on[event];</span>
          if (<span class="cstat-no" title="statement not covered" >event in on) {</span>
            aData.on[event] = Array.isArray(handler$1) ? handler$1 : [handler$1];
          }
        }
        // append new listeners for router-link
<span class="cstat-no" title="statement not covered" >        for (var event$1 in on) {</span>
          if (<span class="cstat-no" title="statement not covered" >event$1 in aData.on) {</span>
...
&nbsp;
        var aAttrs = (<span class="cstat-no" title="statement not covered" >a.data.attrs = extend({}, a.data.attrs));</span>
<span class="cstat-no" title="statement not covered" >        aAttrs.href = href;</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    return h(this.tag, data, this.$slots.default)</span>
  }
};
&nbsp;
function <span class="fstat-no" title="function not covered" >guardEvent (e</span>) {
  // don't redirect with control keys
<span class="cstat-no" title="statement not covered" >  if (e.metaKey || e.altKey || e.ctrlKey || e.shiftKey) { return }</span>
  // don't redirect when preventDefault called
  if (e.defaultPrevented) { return }
  // don't redirect on right click
  if (e.button !== undefined &amp;&amp; e.button !== 0) { return }
  // don't redirect if `target="_blank"`
<span class="cstat-no" title="statement not covered" >  if (e.currentTarget &amp;&amp; e.currentTarget.getAttribute) {</span>
    var target = <span class="cstat-no" title="statement not covered" >e.currentTarget.getAttribute('target');</span>
<span class="cstat-no" title="statement not covered" >    if (/\b_blank\b/i.test(target)) { <span class="cstat-no" title="statement not covered" >return }</span></span>
  }
...
&nbsp;
<span class="cstat-no" title="statement not covered" >function <span class="fstat-no" title="function not covered" >findAnchor (c</span>hildren) {</span>
<span class="cstat-no" title="statement not covered" >  if (children) {</span>
    var child;
<span class="cstat-no" title="statement not covered" >    for (var i = <span class="cstat-no" title="statement not covered" >0; i</span> &lt; children.length; i++) {</span>
      child = children[i];
<span class="cstat-no" title="statement not covered" >      if (child.tag === 'a') {</span>
<span class="cstat-no" title="statement not covered" >        return child</span>
      }
<span class="cstat-no" title="statement not covered" >      if (child.children &amp;&amp; (child = findAnchor(child.children))) {</span>
<span class="cstat-no" title="statement not covered" >        return child</span>
      }
    }
  }
...
var _Vue;
&nbsp;
function <span class="fstat-no" title="function not covered" >install (V</span>ue) {
<span class="cstat-no" title="statement not covered" >  if (install.installed &amp;&amp; _Vue === Vue) { return }</span>
<span class="cstat-no" title="statement not covered" >  install.installed = true;</span>
&nbsp;
  _Vue = Vue;
&nbsp;
  var isDef = <span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >function (v</span>) { <span class="cstat-no" title="statement not covered" >return v !== u</span></span>ndefined; };
&nbsp;
  var registerInstance = <span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >function (v</span>m, callVal) {</span>
    var i = <span class="cstat-no" title="statement not covered" >vm.$options._parentVnode;</span>
    if (<span class="cstat-no" title="statement not covered" >isDef(i) &amp;&amp; isDef(i = i.data) &amp;&amp; isDef(i = i.registerRouteInstance)) {</span>
      i(vm, callVal);
    }
  };
&nbsp;
<span class="cstat-no" title="statement not covered" >  Vue.mixin({</span>
    beforeCreate: <span class="fstat-no" title="function not covered" >function beforeCreate () {</span>
      if (<span class="cstat-no" title="statement not covered" >isDef(this.$options.router)) {</span>
    ...
    destroyed: <span class="fstat-no" title="function not covered" >function destroyed () {</span>
<span class="cstat-no" title="statement not covered" >      registerInstance(this);</span>
    }
  });
&nbsp;
  Object.defineProperty(Vue.prototype, '$router', {
    get: <span class="fstat-no" title="function not covered" >function get () { <span class="cstat-no" title="statement not covered" >r</span>eturn this._routerRoot._router }</span>
  });
&nbsp;
  Object.defineProperty(Vue.prototype, '$route', {
    get: <span class="fstat-no" title="function not covered" >function get () { <span class="cstat-no" title="statement not covered" >r</span>eturn this._routerRoot._route }</span>
  });
&nbsp;
  Vue.component('RouterView', View);
  Vue.component('RouterLink', Link);
&nbsp;
  var strats = <span class="cstat-no" title="statement not covered" >Vue.config.optionMergeStrategies;</span>
  // use the same hook merging strategy for route hooks
<span class="cstat-no" title="statement not covered" >  strats.beforeRouteEnter = strats.beforeRouteLeave = strats.beforeRouteUpdate = strats.created;</span>
}
&nbsp;
/*  */
&nbsp;
var inBrowser = typeof window !== <span class="cstat-no" title="statement not covered" >'undefined';</span>
&nbsp;
/*  */
&nbsp;
function <span class="fstat-no" title="function not covered" >createRouteMap (</span>
  routes,
  oldPathList,
  oldPathMap,
  oldNameMap
  ...
  var pathList = <span class="cstat-no" title="statement not covered" >oldPathList || [];</span>
  // $flow-disable-line
  var pathMap = <span class="cstat-no" title="statement not covered" >oldPathMap || Object.create(null);</span>
  // $flow-disable-line
  var nameMap = <span class="cstat-no" title="statement not covered" >oldNameMap || Object.create(null);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  routes.forEach(<span class="fstat-no" title="function not covered" >function (<span class="cstat-no" title="statement not covered" >r</span>oute) {</span></span>
    addRouteRecord(pathList, pathMap, nameMap, route);
  });
&nbsp;
  // ensure wildcard routes are always at the end
<span class="cstat-no" title="statement not covered" >  for (var i = <span class="cstat-no" title="statement not covered" >0, l</span> = <span class="cstat-no" title="statement not covered" >pathList.length; i</span> &lt; l; i++) {</span>
    if (pathList[i] === <span class="cstat-no" title="statement not covered" >'*') {</span>
...
&nbsp;
function <span class="fstat-no" title="function not covered" >addRouteRecord (</span>
  pathList,
  pathMap,
  nameMap,
  route,
  ...
  var path = <span class="cstat-no" title="statement not covered" >route.path;</span>
  var name = <span class="cstat-no" title="statement not covered" >route.name;</span>
  if (<span class="cstat-no" title="statement not covered" >process.env.NODE_ENV !== 'production') {</span>
...
<span class="cstat-no" title="statement not covered" >    route.pathToRegexpOptions || {};</span>
  var normalizedPath = normalizePath(path, parent, pathToRegexpOptions.strict);
&nbsp;
  if (typeof route.caseSensitive === <span class="cstat-no" title="statement not covered" >'boolean') {</span>
    pathToRegexpOptions.sensitive = route.caseSensitive;
  }
&nbsp;
  var record = <span class="cstat-no" title="statement not covered" >{</span>
    path: normalizedPath,
...
&nbsp;
  if (<span class="cstat-no" title="statement not covered" >route.children) {</span>
    ...
    route.children.forEach(<span class="fstat-no" title="function not covered" >function (c</span>hild) {
      var childMatchAs = <span class="cstat-no" title="statement not covered" >matchAs</span>
        ? cleanPath((matchAs + "/" + (child.path)))
        : undefined;
<span class="cstat-no" title="statement not covered" >      addRouteRecord(pathList, pathMap, nameMap, child, record, childMatchAs);</span>
    });
  }
&nbsp;
  if (!<span class="cstat-no" title="statement not covered" >pathMap[record.path]) {</span>
    pathList.push(record.path);
    pathMap[record.path] = record;
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (route.alias !== undefined) {</span>
    var aliases = <span class="cstat-no" title="statement not covered" >Array.isArray(route.alias) ? route.alias : [route.alias];</span>
<span class="cstat-no" title="statement not covered" >    for (var i = <span class="cstat-no" title="statement not covered" >0; i</span> &lt; aliases.length; ++i) {</span>
      var alias = aliases[i];
      if (<span class="cstat-no" title="statement not covered" >process.env.NODE_ENV !== 'production' &amp;&amp; alias === path) {</span>
        warn(
          false,
...
&nbsp;
      var aliasRoute = <span class="cstat-no" title="statement not covered" >{</span>
        path: alias,
        children: route.children
      };
<span class="cstat-no" title="statement not covered" >      addRouteRecord(</span>
        pathList,
        pathMap,
        nameMap,
        aliasRoute,
...
&nbsp;
function <span class="fstat-no" title="function not covered" >compileRouteRegex (</span>
  path,
  pathToRegexpOptions
) {
...
&nbsp;
<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >function normalizePath (</span></span>
  path,
  parent,
  strict
) {
  if (!<span class="cstat-no" title="statement not covered" >strict) { path = path.replace(/\/$/, ''); }</span>
<span class="cstat-no" title="statement not covered" >  if (path[0] === '/') { <span class="cstat-no" title="statement not covered" >return path }</span></span>
<span class="cstat-no" title="statement not covered" >  if (parent == null) { <span class="cstat-no" title="statement not covered" >return path }</span></span>
<span class="cstat-no" title="statement not covered" >  return cleanPath(((parent.path) + "/" + path))</span>
}
&nbsp;
/*  */
&nbsp;
&nbsp;
&nbsp;
function <span class="fstat-no" title="function not covered" >createMatcher (</span>
  routes,
  router
) {
  var ref = <span class="cstat-no" title="statement not covered" >createRouteMap(routes);</span>
  var pathList = <span class="cstat-no" title="statement not covered" >ref.pathList;</span>
  var pathMap = <span class="cstat-no" title="statement not covered" >ref.pathMap;</span>
  var nameMap = <span class="cstat-no" title="statement not covered" >ref.nameMap;</span>
&nbsp;
<span class="fstat-no" title="function not covered" >  function addRoutes (r</span>outes) {
<span class="cstat-no" title="statement not covered" >    createRouteMap(routes, pathList, pathMap, nameMap);</span>
  }
&nbsp;
  function <span class="fstat-no" title="function not covered" >match (</span>
    raw,
    currentRoute,
    redirectedFrom
  ) {
    var location = <span class="cstat-no" title="statement not covered" >normalizeLocation(raw, currentRoute, false, router);</span>
    var name = <span class="cstat-no" title="statement not covered" >location.name;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (name) {</span>
      var record = <span class="cstat-no" title="statement not covered" >nameMap[name];</span>
      if (process.env.NODE_ENV !== 'production') {
        warn(record, ("Route with name '" + name + "' does not exist"));
      }
<span class="cstat-no" title="statement not covered" >      if (!record) { <span class="cstat-no" title="statement not covered" >return _createRoute(null, location) }</span></span>
      var paramNames = <span class="cstat-no" title="statement not covered" >record.regex.keys</span>
        .filter(<span class="fstat-no" title="function not covered" >function (k</span>ey) { <span class="cstat-no" title="statement not covered" >return !key.optional; })</span>
        .map(<span class="fstat-no" title="function not covered" >function (k</span>ey) { <span class="cstat-no" title="statement not covered" >return key.name; });</span>
&nbsp;
      if (typeof location.params !== 'object') {
        location.params = {};
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (currentRoute &amp;&amp; typeof currentRoute.params === 'object') {</span>
<span class="cstat-no" title="statement not covered" >        for (var key in currentRoute.<span class="cstat-no" title="statement not covered" >params) {</span></span>
...
<span class="cstat-no" title="statement not covered" >      return _createRoute(record, location, redirectedFrom)</span>
    } else <span class="cstat-no" title="statement not covered" >if (location.path) {</span>
<span class="cstat-no" title="statement not covered" >      location.params = {};</span>
<span class="cstat-no" title="statement not covered" >      for (var i = <span class="cstat-no" title="statement not covered" >0; i</span> &lt; pathList.length; i++) {</span>
        var path = <span class="cstat-no" title="statement not covered" >pathList[i];</span>
        var record$1 = <span class="cstat-no" title="statement not covered" >pathMap[path];</span>
<span class="cstat-no" title="statement not covered" >        if (matchRoute(record$1.regex, location.path, location.params)) {</span>
<span class="cstat-no" title="statement not covered" >          return _createRoute(record$1, location, redirectedFrom)</span>
        }
      }
    }
    // no match
<span class="cstat-no" title="statement not covered" >    return _createRoute(null, location)</span>
  }
&nbsp;
  function <span class="fstat-no" title="function not covered" >redirect (</span>
    record,
    location
  ) {
    var originalRedirect = <span class="cstat-no" title="statement not covered" >record.redirect;</span>
    var redirect = typeof originalRedirect === <span class="cstat-no" title="statement not covered" >'function'</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!redirect || typeof redirect !== 'object') {</span>
      if (process.env.NODE_ENV !== 'production') {
        warn(
...
&nbsp;
    var re = <span class="cstat-no" title="statement not covered" >redirect;</span>
    var name = <span class="cstat-no" title="statement not covered" >re.name;</span>
    var path = <span class="cstat-no" title="statement not covered" >re.path;</span>
    var query = <span class="cstat-no" title="statement not covered" >location.query;</span>
    var hash = <span class="cstat-no" title="statement not covered" >location.hash;</span>
    var params = <span class="cstat-no" title="statement not covered" >location.params;</span>
...
<span class="cstat-no" title="statement not covered" >    if (name) {</span>
      ...
      var targetRecord = <span class="cstat-no" title="statement not covered" >nameMap[name];</span>
      if (process.env.NODE_ENV !== 'production') {
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function alias (</span>
    record,
    location,
    matchAs
  ) {
    var aliasedPath = fillParams(matchAs, location.params, ("aliased route with path \"" + matchAs + "\""));
    var aliasedMatch = <span class="cstat-no" title="statement not covered" >match({</span>
      _normalized: true,
      path: aliasedPath
    });
<span class="cstat-no" title="statement not covered" >    if (aliasedMatch) {</span>
      var matched = <span class="cstat-no" title="statement not covered" >aliasedMatch.matched;</span>
      var aliasedRecord = <span class="cstat-no" title="statement not covered" >matched[matched.length - 1];</span>
      location.params = aliasedMatch.params;
<span class="cstat-no" title="statement not covered" >      return _createRoute(aliasedRecord, location)</span>
    }
<span class="cstat-no" title="statement not covered" >    return _createRoute(null, location)</span>
  }
&nbsp;
  function <span class="fstat-no" title="function not covered" >_createRoute (</span>
    record,
    location,
    redirectedFrom
  ) {
<span class="cstat-no" title="statement not covered" >    if (record &amp;&amp; record.redirect) {</span>
...
&nbsp;
function <span class="fstat-no" title="function not covered" >matchRoute (</span>
  regex,
  path,
  params
) {
  var m = <span class="cstat-no" title="statement not covered" >path.match(regex);</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  for (var i = <span class="cstat-no" title="statement not covered" >1, l</span>en = <span class="cstat-no" title="statement not covered" >m.length; i</span> &lt; len; ++i) {</span>
    var key = <span class="cstat-no" title="statement not covered" >regex.keys[i - 1];</span>
    var val = typeof m[i] === <span class="cstat-no" title="statement not covered" >'string' ? decodeURIComponent(m[i]) : m[i];</span>
    if (<span class="cstat-no" title="statement not covered" >key) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >function resolveRecordPath (p</span>ath, record) {</span>
<span class="cstat-no" title="statement not covered" >  return resolvePath(path, record.parent ? record.parent.path : '/', true)</span>
}
&nbsp;
/*  */
&nbsp;
...
var Time =
<span class="cstat-no" title="statement not covered" >  inBrowser &amp;&amp; window.performance &amp;&amp; window.performance.now</span>
    ? window.performance
    : Date;
&nbsp;
function <span class="fstat-no" title="function not covered" >genStateKey () {</span>
<span class="cstat-no" title="statement not covered" >  return Time.now().toFixed(3)</span>
}
&nbsp;
var _key = <span class="cstat-no" title="statement not covered" >genStateKey();</span>
&nbsp;
function <span class="fstat-no" title="function not covered" >getStateKey () {</span>
<span class="cstat-no" title="statement not covered" >  return _key</span>
}
&nbsp;
function <span class="fstat-no" title="function not covered" >setStateKey (k</span>ey) {
<span class="cstat-no" title="statement not covered" >  return (_key = key)</span>
}
&nbsp;
/*  */
&nbsp;
var positionStore = <span class="cstat-no" title="statement not covered" >Object.create(null);</span>
&nbsp;
function <span class="fstat-no" title="function not covered" >setupScroll () {</span>
  // Prevent browser scroll behavior on History popstate
  if (<span class="cstat-no" title="statement not covered" >'scrollRestoration' in window.history) {</span>
  ...
  var protocolAndPath = <span class="cstat-no" title="statement not covered" >window.location.protocol + '//' + window.location.host;</span>
  var absolutePath = <span class="cstat-no" title="statement not covered" >window.location.href.replace(protocolAndPath, '');</span>
  // preserve existing history state as it could be overriden by the user
  var stateCopy = <span class="cstat-no" title="statement not covered" >extend({}, window.history.state);</span>
...
<span class="cstat-no" title="statement not covered" >    window.removeEventListener('popstate', handlePopState);</span>
  }
}
&nbsp;
...
<span class="cstat-no" title="statement not covered" >  if (!router.app) {</span>
    return
  }
&nbsp;
  var behavior = <span class="cstat-no" title="statement not covered" >router.options.scrollBehavior;</span>
  if (!<span class="cstat-no" title="statement not covered" >behavior) {</span>
    return
  }
&nbsp;
  if (process.env.NODE_ENV !== 'production') {
...
&nbsp;
  ...
  router.app.$nextTick(<span class="fstat-no" title="function not covered" >function () {</span>
    var position = getScrollPosition();
    var shouldScroll = <span class="cstat-no" title="statement not covered" >behavior.call(</span>
      router,
      to,
      from,
      isPop ? position : null
...
&nbsp;
    if (!<span class="cstat-no" title="statement not covered" >shouldScroll) {</span>
      return
    }
&nbsp;
    if (typeof shouldScroll.then === 'function') {
      shouldScroll
        .then(<span class="fstat-no" title="function not covered" >function (s</span>houldScroll) {
<span class="cstat-no" title="statement not covered" >          scrollToPosition((shouldScroll), position);</span>
        })
        .catch(<span class="fstat-no" title="function not covered" >function (e</span>rr) {
          if (<span class="cstat-no" title="statement not covered" >process.env.NODE_ENV !== 'production') {</span>
...
&nbsp;
function <span class="fstat-no" title="function not covered" >saveScrollPosition () {</span>
  var key = <span class="cstat-no" title="statement not covered" >getStateKey();</span>
  if (<span class="cstat-no" title="statement not covered" >key) {</span>
    positionStore[key] = {
...
&nbsp;
function <span class="fstat-no" title="function not covered" >handlePopState (e</span>) {
<span class="cstat-no" title="statement not covered" >  saveScrollPosition();</span>
  if (e.state &amp;&amp; e.state.key) {
    setStateKey(e.state.key);
  }
}
&nbsp;
<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >function getScrollPosition () {</span></span>
  var key = <span class="cstat-no" title="statement not covered" >getStateKey();</span>
<span class="cstat-no" title="statement not covered" >  if (key) {</span>
<span class="cstat-no" title="statement not covered" >    return positionStore[key]</span>
  }
}
&nbsp;
<span class="fstat-no" title="function not covered" >function getElementPosition (e</span>l, offset) {
  var docEl = <span class="cstat-no" title="statement not covered" >document.documentElement;</span>
  var docRect = docEl.getBoundingClientRect();
  var elRect = <span class="cstat-no" title="statement not covered" >el.getBoundingClientRect();</span>
<span class="cstat-no" title="statement not covered" >  return {</span>
...
&nbsp;
function <span class="fstat-no" title="function not covered" >isValidPosition (o</span>bj) {
<span class="cstat-no" title="statement not covered" >  return isNumber(obj.x) || isNumber(obj.y)</span>
}
&nbsp;
function <span class="fstat-no" title="function not covered" >normalizePosition (o</span>bj) {
<span class="cstat-no" title="statement not covered" >  return {</span>
...
&nbsp;
function <span class="fstat-no" title="function not covered" >isNumber (v</span>) {
<span class="cstat-no" title="statement not covered" >  return typeof v === '</span>number'
}
&nbsp;
var hashStartsWithNumberRE = <span class="cstat-no" title="statement not covered" >/^#\d/;</span>
&nbsp;
function <span class="fstat-no" title="function not covered" >scrollToPosition (s</span>houldScroll, position) {
  var isObject = typeof shouldScroll === <span class="cstat-no" title="statement not covered" >'object';</span>
<span class="cstat-no" title="statement not covered" >  if (isObject &amp;&amp; typeof shouldScroll.selector === 'string') {</span>
    // getElementById would still fail if the selector contains a more complicated query like #main[data-attr]
    // but at the same time, it doesn't make much sense to select an element with an id and an extra selector
    var el = <span class="cstat-no" title="statement not covered" >hashStartsWithNumberRE.test(shouldScroll.selector) // $flow-disable-line</span>
      ? document.getElementById(shouldScroll.selector.slice(1)) // $flow-disable-line
      : document.querySelector(shouldScroll.selector);
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (el) {</span>
      var offset =
<span class="cstat-no" title="statement not covered" >        shouldScroll.offset &amp;&amp; typeof shouldScroll.offset === 'object'</span>
          ? shouldScroll.offset
          : {};
      offset = normalizeOffset(offset);
<span class="cstat-no" title="statement not covered" >      position = getElementPosition(el, offset);</span>
    } else if (<span class="cstat-no" title="statement not covered" >isValidPosition(shouldScroll)) {</span>
      position = normalizePosition(shouldScroll);
    }
  } else if (<span class="cstat-no" title="statement not covered" >isObject &amp;&amp; isValidPosition(shouldScroll)) {</span>
    position = normalizePosition(shouldScroll);
  }
&nbsp;
  if (<span class="cstat-no" title="statement not covered" >position) {</span>
...
<span class="cstat-no" title="statement not covered" >  inBrowser &amp;&amp;</span>
  (function () {
...
&nbsp;
function <span class="fstat-no" title="function not covered" >pushState (u</span>rl, replace) {
<span class="cstat-no" title="statement not covered" >  saveScrollPosition();</span>
  // try...catch the pushState call to get around Safari
  // DOM Exception 18 where it limits to 100 pushState calls
  var history = <span class="cstat-no" title="statement not covered" >window.history;</span>
<span class="cstat-no" title="statement not covered" >  try {</span>
<span class="cstat-no" title="statement not covered" >    if (replace) {</span>
      // preserve existing history state as it could be overriden by the user
      var stateCopy = <span class="cstat-no" title="statement not covered" >extend({}, history.state);</span>
<span class="cstat-no" title="statement not covered" >      stateCopy.key = getStateKey();</span>
      history.replaceState(stateCopy, '', url);
    } else {
<span class="cstat-no" title="statement not covered" >      history.pushState({ key: setStateKey(genStateKey()) }, '', url);</span>
    }
  } catch (e) {
<span class="cstat-no" title="statement not covered" >    window.location[replace ? 'replace' : 'assign'](url);</span>
  }
}
&nbsp;
function <span class="fstat-no" title="function not covered" >replaceState (u</span>rl) {
<span class="cstat-no" title="statement not covered" >  pushState(url, true);</span>
}
&nbsp;
/*  */
&nbsp;
function <span class="fstat-no" title="function not covered" >runQueue (q</span>ueue, fn, cb) {
  var step = <span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >function (i</span>ndex) {</span>
    if (<span class="cstat-no" title="statement not covered" >index &gt;= queue.length) {</span>
      cb();
    } else {
      if (queue[index]) {
        fn(queue[index], <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >          step(index + 1);</span>
        });
      } else {
        step(index + 1);
      }
...
<span class="cstat-no" title="statement not covered" >  step(0);</span>
}
&nbsp;
/*  */
&nbsp;
function <span class="fstat-no" title="function not covered" >resolveAsyncComponents (m</span>atched) {
<span class="cstat-no" title="statement not covered" >  return <span class="fstat-no" title="function not covered" >function (t</span>o, from, next) {</span>
    var <span class="cstat-no" title="statement not covered" >hasAsync = false;</span>
    var pending = <span class="cstat-no" title="statement not covered" >0;</span>
    var error = <span class="cstat-no" title="statement not covered" >null;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    flatMapComponents(matched, <span class="fstat-no" title="function not covered" >function (d</span>ef, _, match, key) {</span>
      // if it's a function and doesn't have cid attached,
      // assume it's an async component resolve function.
      // we are not using Vue's default async resolving mechanism because
      // we want to halt the navigation until the incoming component has been
      // resolved.
<span class="cstat-no" title="statement not covered" >      if (typeof def === 'function' &amp;&amp; def.cid === undefined) {</span>
<span class="cstat-no" title="statement not covered" >        hasAsync = true;</span>
        pending++;
&nbsp;
        var resolve = <span class="cstat-no" title="statement not covered" >once(<span class="fstat-no" title="function not covered" >function (r</span>esolvedDef) {</span>
...
&nbsp;
        var reject = <span class="cstat-no" title="statement not covered" >once(<span class="fstat-no" title="function not covered" >function (r</span>eason) {</span>
          var msg = <span class="cstat-no" title="statement not covered" >"Failed to resolve async component " + key + ": " + reason;</span>
...
&nbsp;
        var res;
<span class="cstat-no" title="statement not covered" >        try {</span>
<span class="cstat-no" title="statement not covered" >          res = def(resolve, reject);</span>
        } catch (e) {
<span class="cstat-no" title="statement not covered" >          reject(e);</span>
        }
<span class="cstat-no" title="statement not covered" >        if (res) {</span>
<span class="cstat-no" title="statement not covered" >          if (typeof res.then === 'function') {</span>
<span class="cstat-no" title="statement not covered" >            res.then(resolve, reject);</span>
          } else {
            // new syntax in Vue 2.3
            var comp = <span class="cstat-no" title="statement not covered" >res.component;</span>
            if (<span class="cstat-no" title="statement not covered" >comp &amp;&amp; typeof comp.then === 'function') {</span>
...
&nbsp;
function <span class="fstat-no" title="function not covered" >flatMapComponents (</span>
  matched,
  fn
) {
<span class="cstat-no" title="statement not covered" >  return flatten(matched.map(<span class="fstat-no" title="function not covered" >function (m</span>) {</span>
<span class="cstat-no" title="statement not covered" >    return Object.keys(m.components).map(<span class="fstat-no" title="function not covered" >function (k</span>ey) { <span class="cstat-no" title="statement not covered" >return fn(</span></span>
      m.components[key],
      m.instances[key],
      m, key
    ); })
...
&nbsp;
function <span class="fstat-no" title="function not covered" >flatten (a</span>rr) {
<span class="cstat-no" title="statement not covered" >  return Array.prototype.concat.apply([], arr)</span>
}
&nbsp;
var hasSymbol =
  typeof Symbol === <span class="cstat-no" title="statement not covered" >'function' &amp;&amp;</span>
  typeof Symbol.toStringTag === 'symbol';
&nbsp;
function isESModule (<span class="cstat-no" title="statement not covered" >obj) {</span>
...
// return that Promise.
function <span class="fstat-no" title="function not covered" >once (f</span>n) {
  var <span class="cstat-no" title="statement not covered" >called = false;</span>
<span class="cstat-no" title="statement not covered" >  return <span class="fstat-no" title="function not covered" >function () {</span></span>
    var args = <span class="cstat-no" title="statement not covered" >[], l</span>en = <span class="cstat-no" title="statement not covered" >arguments.length;</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (called) { return }</span>
    called = true;
...
var NavigationFailureType = {
  redirected: <span class="cstat-no" title="statement not covered" >1,</span>
  aborted: <span class="cstat-no" title="statement not covered" >2,</span>
  cancelled: <span class="cstat-no" title="statement not covered" >3,</span>
  duplicated: <span class="cstat-no" title="statement not covered" >4</span>
};
&nbsp;
function <span class="fstat-no" title="function not covered" >createNavigationRedirectedError (f</span>rom, to) {
<span class="cstat-no" title="statement not covered" >  return createRouterError(</span>
    from,
    to,
...
&nbsp;
function <span class="fstat-no" title="function not covered" >createNavigationCancelledError (f</span>rom, to) {
<span class="cstat-no" title="statement not covered" >  return createRouterError(</span>
    from,
    to,
...
&nbsp;
<span class="fstat-no" title="function not covered" >function createNavigationAbortedError (f</span>rom, to) {
<span class="cstat-no" title="statement not covered" >  return createRouterError(</span>
    from,
    to,
...
&nbsp;
function <span class="fstat-no" title="function not covered" >createRouterError (f</span>rom, to, type, message) {
  var error = <span class="cstat-no" title="statement not covered" >new Error(message);</span>
...
&nbsp;
var propertiesToLog = <span class="cstat-no" title="statement not covered" >['params', 'query', 'hash'];</span>
&nbsp;
<span class="fstat-no" title="function not covered" >function stringifyRoute (t</span>o) {
<span class="cstat-no" title="statement not covered" >  if (typeof to === 'string') { <span class="cstat-no" title="statement not covered" >return to }</span></span>
<span class="cstat-no" title="statement not covered" >  if ('path' in to) { <span class="cstat-no" title="statement not covered" >return to.path }</span></span>
  var location = <span class="cstat-no" title="statement not covered" >{};</span>
  propertiesToLog.forEach(<span class="fstat-no" title="function not covered" >function (k</span>ey) {
    if (<span class="cstat-no" title="statement not covered" >key in to) { location[key] = to[key]; }</span>
  });
<span class="cstat-no" title="statement not covered" >  return JSON.stringify(location, null, 2)</span>
}
&nbsp;
/*  */
&nbsp;
var History = <span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >function History (r</span>outer, base) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >History.prototype.listen = <span class="fstat-no" title="function not covered" >function listen (c</span>b) {</span>
<span class="cstat-no" title="statement not covered" >  this.cb = cb;</span>
};
&nbsp;
History.prototype.onReady = <span class="fstat-no" title="function not covered" >function onReady (c</span>b, errorCb) {
  if (<span class="cstat-no" title="statement not covered" >this.ready) {</span>
    cb();
  } else {
...
&nbsp;
History.prototype.onError = <span class="fstat-no" title="function not covered" >function onError (e</span>rrorCb) {
<span class="cstat-no" title="statement not covered" >  this.errorCbs.push(errorCb);</span>
};
&nbsp;
History.prototype.transitionTo = <span class="fstat-no" title="function not covered" >function transitionTo (</span>
  location,
  onComplete,
  onAbort
) {
    var this$1 = <span class="cstat-no" title="statement not covered" >this;</span>
&nbsp;
  var route = <span class="cstat-no" title="statement not covered" >this.router.match(location, this.current);</span>
<span class="cstat-no" title="statement not covered" >  this.confirmTransition(</span>
    route,
<span class="fstat-no" title="function not covered" >    function () {</span>
      var prev = <span class="cstat-no" title="statement not covered" >this$1.current;</span>
<span class="cstat-no" title="statement not covered" >      this$1.updateRoute(route);</span>
      onComplete &amp;&amp; onComplete(route);
      this$1.ensureURL();
      this$1.router.afterHooks.forEach(<span class="fstat-no" title="function not covered" >function (h</span>ook) {
<span class="cstat-no" title="statement not covered" >        hook &amp;&amp; hook(route, prev);</span>
      });
&nbsp;
      // fire ready cbs once
      if (!this$1.ready) {
        this$1.ready = true;
        this$1.readyCbs.forEach(<span class="fstat-no" title="function not covered" >function (c</span>b) {
<span class="cstat-no" title="statement not covered" >          cb(route);</span>
        });
      }
    },
<span class="fstat-no" title="function not covered" >    function (e</span>rr) {
      if (<span class="cstat-no" title="statement not covered" >onAbort) {</span>
        onAbort(err);
      }
      if (err &amp;&amp; !this$1.ready) {
        this$1.ready = true;
        ...
        if (!isRouterError(err, NavigationFailureType.redirected)) {
          this$1.readyErrorCbs.forEach(<span class="fstat-no" title="function not covered" >function (c</span>b) {
...
&nbsp;
History.prototype.confirmTransition = <span class="fstat-no" title="function not covered" >function confirmTransition (r</span>oute, onComplete, onAbort) {
    var this$1 = <span class="cstat-no" title="statement not covered" >this;</span>
&nbsp;
  var current = <span class="cstat-no" title="statement not covered" >this.current;</span>
  var abort = <span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >function (<span class="cstat-no" title="statement not covered" >e</span>rr) {</span></span>
    // changed after adding errors with
    // https://github.com/vuejs/vue-router/pull/3047 before that change,
    // redirect and aborted navigation would produce an err == null
    if (!isRouterError(err) &amp;&amp; isError(err)) {
      if (this$1.errorCbs.length) {
        this$1.errorCbs.forEach(<span class="fstat-no" title="function not covered" >function (c</span>b) {
<span class="cstat-no" title="statement not covered" >          cb(err);</span>
        });
      } else {
  ...
  var lastRouteIndex = <span class="cstat-no" title="statement not covered" >route.matched.length - 1;</span>
  var lastCurrentIndex = <span class="cstat-no" title="statement not covered" >current.matched.length - 1;</span>
<span class="cstat-no" title="statement not covered" >  if (</span>
    ...
    this.ensureURL();
<span class="cstat-no" title="statement not covered" >    return abort(createNavigationDuplicatedError(current, route))</span>
  }
&nbsp;
  var ref = resolveQueue(
    ...
    var updated = <span class="cstat-no" title="statement not covered" >ref.updated;</span>
    var deactivated = <span class="cstat-no" title="statement not covered" >ref.deactivated;</span>
    var activated = <span class="cstat-no" title="statement not covered" >ref.activated;</span>
&nbsp;
  var queue = <span class="cstat-no" title="statement not covered" >[].concat(</span>
    ...
    activated.map(<span class="fstat-no" title="function not covered" >function (m</span>) { <span class="cstat-no" title="statement not covered" >return m.beforeEnter; }),</span>
    // async components
    resolveAsyncComponents(activated)
  );
&nbsp;
<span class="cstat-no" title="statement not covered" >  this.pending = route;</span>
  var iterator = <span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >function (h</span>ook, next) {</span>
<span class="cstat-no" title="statement not covered" >    if (this$1.pending !== route) {</span>
<span class="cstat-no" title="statement not covered" >      return abort(createNavigationCancelledError(current, route))</span>
    }
<span class="cstat-no" title="statement not covered" >    try {</span>
<span class="cstat-no" title="statement not covered" >      hook(route, current, <span class="fstat-no" title="function not covered" >function (<span class="cstat-no" title="statement not covered" >t</span>o) {</span></span>
        if (to === false) {
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  runQueue(queue, iterator, <span class="fstat-no" title="function not covered" >function () {</span></span>
    var postEnterCbs = <span class="cstat-no" title="statement not covered" >[];</span>
    var isValid = <span class="fstat-no" title="function not covered" >function () { <span class="cstat-no" title="statement not covered" >r</span>eturn this$1.current === route; };</span>
...
<span class="cstat-no" title="statement not covered" >      this$1.pending = null;</span>
      onComplete(route);
      if (this$1.router.app) {
        this$1.router.app.$nextTick(<span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >          postEnterCbs.forEach(<span class="fstat-no" title="function not covered" >function (c</span>b) {</span>
...
&nbsp;
History.prototype.updateRoute = <span class="fstat-no" title="function not covered" >function updateRoute (r</span>oute) {
<span class="cstat-no" title="statement not covered" >  this.current = route;</span>
  this.cb &amp;&amp; this.cb(route);
};
&nbsp;
History.prototype.setupListeners = <span class="fstat-no" title="function not covered" >function setupListeners () {</span>
  // Default implementation is empty
};
&nbsp;
History.prototype.teardownListeners = <span class="fstat-no" title="function not covered" >function teardownListeners () {</span>
<span class="cstat-no" title="statement not covered" >  this.listeners.forEach(<span class="fstat-no" title="function not covered" >function (c</span>leanupListener) {</span>
<span class="cstat-no" title="statement not covered" >    cleanupListener();</span>
  });
  this.listeners = [];
};
&nbsp;
<span class="fstat-no" title="function not covered" >function normalizeBase (b</span>ase) {
...
<span class="cstat-no" title="statement not covered" >    if (inBrowser) {</span>
      // respect &lt;base&gt; tag
      var baseEl = <span class="cstat-no" title="statement not covered" >document.querySelector('base');</span>
      base = (baseEl &amp;&amp; baseEl.getAttribute('href')) || '/';
      // strip full URL origin
<span class="cstat-no" title="statement not covered" >      base = base.replace(/^https?:\/\/[^\/]+/, '');</span>
    } else {
<span class="cstat-no" title="statement not covered" >      base = '/';</span>
    }
  }
  // make sure there's the starting slash
  if (base.charAt(0) !== <span class="cstat-no" title="statement not covered" >'/') {</span>
    base = '/' + base;
  }
  // remove trailing slash
<span class="cstat-no" title="statement not covered" >  return base.replace(/\/$/, '')</span>
}
&nbsp;
<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >function resolveQueue (</span></span>
  current,
  next
) {
  var i;
  var max = <span class="cstat-no" title="statement not covered" >Math.max(current.length, next.length);</span>
...
&nbsp;
function <span class="fstat-no" title="function not covered" >extractGuards (</span>
  records,
  name,
  bind,
  reverse
) {
  var guards = <span class="cstat-no" title="statement not covered" >flatMapComponents(records, <span class="fstat-no" title="function not covered" >function (d</span>ef, instance, match, key) {</span>
    var guard = extractGuard(def, name);
<span class="cstat-no" title="statement not covered" >    if (guard) {</span>
<span class="cstat-no" title="statement not covered" >      return Array.isArray(guard)</span>
        ? guard.map(<span class="fstat-no" title="function not covered" >function (g</span>uard) { <span class="cstat-no" title="statement not covered" >return bind(guard, instance, match, key); })</span>
        : bind(guard, instance, match, key)
    }
  });
<span class="cstat-no" title="statement not covered" >  return flatten(reverse ? guards.reverse() : guards)</span>
}
&nbsp;
<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >function extractGuard (</span></span>
  def,
  key
) {
  if (typeof def !== <span class="cstat-no" title="statement not covered" >'function') {</span>
    // extend now so that global mixins are applied.
    def = _Vue.extend(def);
  }
<span class="cstat-no" title="statement not covered" >  return def.options[key]</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function extractLeaveGuards (d</span>eactivated) {
<span class="cstat-no" title="statement not covered" >  return extractGuards(deactivated, 'beforeRouteLeave', bindGuard, true)</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function extractUpdateHooks (u</span>pdated) {
<span class="cstat-no" title="statement not covered" >  return extractGuards(updated, 'beforeRouteUpdate', bindGuard)</span>
}
&nbsp;
function <span class="fstat-no" title="function not covered" >bindGuard (g</span>uard, instance) {
<span class="cstat-no" title="statement not covered" >  if (instance) {</span>
<span class="cstat-no" title="statement not covered" >    return <span class="fstat-no" title="function not covered" >function boundRouteGuard () {</span></span>
<span class="cstat-no" title="statement not covered" >      return guard.apply(instance, arguments)</span>
    }
  }
}
&nbsp;
<span class="fstat-no" title="function not covered" >function extractEnterGuards (</span>
  activated,
  cbs,
  isValid
) {
<span class="cstat-no" title="statement not covered" >  return extractGuards(</span>
    activated,
    'beforeRouteEnter',
<span class="fstat-no" title="function not covered" >    function (g</span>uard, _, match, key) {
<span class="cstat-no" title="statement not covered" >      return bindEnterGuard(guard, match, key, cbs, isValid)</span>
    }
  )
}
&nbsp;
<span class="fstat-no" title="function not covered" >function bindEnterGuard (</span>
  guard,
  match,
  key,
  cbs,
...
<span class="cstat-no" title="statement not covered" >  return <span class="fstat-no" title="function not covered" >function routeEnterGuard (t</span>o, from, next) {</span>
<span class="cstat-no" title="statement not covered" >    return guard(to, from, <span class="fstat-no" title="function not covered" >function (c</span>b) {</span>
      if (typeof cb === <span class="cstat-no" title="statement not covered" >'function') {</span>
        cbs.push(<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >function () {</span></span>
          // #750
...
&nbsp;
function <span class="fstat-no" title="function not covered" >poll (</span>
  ...
  if (
<span class="cstat-no" title="statement not covered" >    instances[key] &amp;&amp;</span>
    !instances[key]._isBeingDestroyed // do not reuse being destroyed instance
  ) {
    cb(instances[key]);
  } else if (isValid()) {
    setTimeout(<span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >      poll(cb, instances, key, isValid);</span>
    }, 16);
  }
}
&nbsp;
/*  */
&nbsp;
var HTML5History = /*@__PURE__*/(<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >function (H</span>istory) {</span>
  function <span class="fstat-no" title="function not covered" >HTML5History (r</span>outer, base) {
<span class="cstat-no" title="statement not covered" >    History.call(this, router, base);</span>
&nbsp;
...
&nbsp;
  HTML5History.prototype.setupListeners = <span class="fstat-no" title="function not covered" >function setupListeners () {</span>
    var this$1 = <span class="cstat-no" title="statement not covered" >this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (this.listeners.length &gt; 0) {</span>
      return
    }
&nbsp;
    var router = <span class="cstat-no" title="statement not covered" >this.router;</span>
    var expectScroll = <span class="cstat-no" title="statement not covered" >router.options.scrollBehavior;</span>
    var supportsScroll = <span class="cstat-no" title="statement not covered" >supportsPushState &amp;&amp; expectScroll;</span>
&nbsp;
    if (<span class="cstat-no" title="statement not covered" >supportsScroll) {</span>
      this.listeners.push(setupScroll());
    }
&nbsp;
    var handleRoutingEvent = <span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >function () {</span></span>
      var current = <span class="cstat-no" title="statement not covered" >this$1.current;</span>
&nbsp;
      // Avoiding first `popstate` event dispatched in some browsers but first
      // history route not updated since async guard at the same time.
      var location = <span class="cstat-no" title="statement not covered" >getLocation(this$1.base);</span>
      if (<span class="cstat-no" title="statement not covered" >this$1.current === START &amp;&amp; location === this$1._startLocation) {</span>
        return
      }
&nbsp;
      this$1.transitionTo(location, <span class="fstat-no" title="function not covered" >function (r</span>oute) {
        if (<span class="cstat-no" title="statement not covered" >supportsScroll) {</span>
          handleScroll(router, route, current, true);
        }
      });
    };
<span class="cstat-no" title="statement not covered" >    window.addEventListener('popstate', handleRoutingEvent);</span>
    this.listeners.push(<span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >      window.removeEventListener('popstate', handleRoutingEvent);</span>
    });
  };
&nbsp;
  HTML5History.prototype.go = <span class="fstat-no" title="function not covered" >function go (n</span>) {
<span class="cstat-no" title="statement not covered" >    window.history.go(n);</span>
  };
&nbsp;
  HTML5History.prototype.push = <span class="fstat-no" title="function not covered" >function push (l</span>ocation, onComplete, onAbort) {
    var this$1 = <span class="cstat-no" title="statement not covered" >this;</span>
&nbsp;
    var ref = <span class="cstat-no" title="statement not covered" >this;</span>
    var fromRoute = ref.current;
<span class="cstat-no" title="statement not covered" >    this.transitionTo(location, <span class="fstat-no" title="function not covered" >function (r</span>oute) {</span>
<span class="cstat-no" title="statement not covered" >      pushState(cleanPath(this$1.base + route.fullPath));</span>
      handleScroll(this$1.router, route, fromRoute, false);
      onComplete &amp;&amp; onComplete(route);
    }, onAbort);
  };
&nbsp;
  HTML5History.prototype.replace = <span class="fstat-no" title="function not covered" >function replace (l</span>ocation, onComplete, onAbort) {
    var this$1 = <span class="cstat-no" title="statement not covered" >this;</span>
&nbsp;
    var ref = <span class="cstat-no" title="statement not covered" >this;</span>
    var fromRoute = ref.current;
<span class="cstat-no" title="statement not covered" >    this.transitionTo(location, <span class="fstat-no" title="function not covered" >function (r</span>oute) {</span>
<span class="cstat-no" title="statement not covered" >      replaceState(cleanPath(this$1.base + route.fullPath));</span>
      handleScroll(this$1.router, route, fromRoute, false);
      onComplete &amp;&amp; onComplete(route);
    }, onAbort);
  };
&nbsp;
  HTML5History.prototype.ensureURL = <span class="fstat-no" title="function not covered" >function ensureURL (p</span>ush) {
<span class="cstat-no" title="statement not covered" >    if (getLocation(this.base) !== this.current.fullPath) {</span>
      var current = <span class="cstat-no" title="statement not covered" >cleanPath(this.base + this.current.fullPath);</span>
<span class="cstat-no" title="statement not covered" >      push ? pushState(current) : replaceState(current);</span>
    }
  };
&nbsp;
  HTML5History.prototype.getCurrentLocation = <span class="fstat-no" title="function not covered" >function getCurrentLocation () {</span>
<span class="cstat-no" title="statement not covered" >    return getLocation(this.base)</span>
  };
&nbsp;
<span class="cstat-no" title="statement not covered" >  return HTML5History;</span>
}(History));
&nbsp;
function <span class="fstat-no" title="function not covered" >getLocation (b</span>ase) {
  var path = <span class="cstat-no" title="statement not covered" >decodeURI(window.location.pathname);</span>
  if (base &amp;&amp; path.toLowerCase().indexOf(base.toLowerCase()) === 0) {
    path = path.slice(base.length);
  }
<span class="cstat-no" title="statement not covered" >  return (path || '/') + window.location.search + window.location.hash</span>
}
&nbsp;
/*  */
&nbsp;
var HashHistory = /*@__PURE__*/(<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >function (H</span>istory) {</span>
  function <span class="fstat-no" title="function not covered" >HashHistory (r</span>outer, base, fallback) {
<span class="cstat-no" title="statement not covered" >    History.call(this, router, base);</span>
...
&nbsp;
  ...
  HashHistory.prototype.setupListeners = <span class="fstat-no" title="function not covered" >function setupListeners () {</span>
    var this$1 = <span class="cstat-no" title="statement not covered" >this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (this.listeners.length &gt; 0) {</span>
      return
...
&nbsp;
    var handleRoutingEvent = <span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >function () {</span></span>
      var current = <span class="cstat-no" title="statement not covered" >this$1.current;</span>
      if (!<span class="cstat-no" title="statement not covered" >ensureSlash()) {</span>
        return
      }
      this$1.transitionTo(getHash(), <span class="fstat-no" title="function not covered" >function (r</span>oute) {
        if (<span class="cstat-no" title="statement not covered" >supportsScroll) {</span>
    ...
    var eventType = <span class="cstat-no" title="statement not covered" >supportsPushState ? 'popstate' : 'hashchange';</span>
<span class="cstat-no" title="statement not covered" >    window.addEventListener(</span>
      eventType,
      handleRoutingEvent
    );
    this.listeners.push(<span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >      window.removeEventListener(eventType, handleRoutingEvent);</span>
    });
  };
&nbsp;
  HashHistory.prototype.push = <span class="fstat-no" title="function not covered" >function push (l</span>ocation, onComplete, onAbort) {
    var this$1 = <span class="cstat-no" title="statement not covered" >this;</span>
&nbsp;
    var ref = <span class="cstat-no" title="statement not covered" >this;</span>
    var fromRoute = ref.current;
<span class="cstat-no" title="statement not covered" >    this.transitionTo(</span>
      location,
<span class="fstat-no" title="function not covered" >      function (r</span>oute) {
<span class="cstat-no" title="statement not covered" >        pushHash(route.fullPath);</span>
        handleScroll(this$1.router, route, fromRoute, false);
        onComplete &amp;&amp; onComplete(route);
      },
      onAbort
...
&nbsp;
  HashHistory.prototype.replace = <span class="fstat-no" title="function not covered" >function replace (l</span>ocation, onComplete, onAbort) {
    var this$1 = <span class="cstat-no" title="statement not covered" >this;</span>
&nbsp;
    var ref = <span class="cstat-no" title="statement not covered" >this;</span>
    var fromRoute = ref.current;
<span class="cstat-no" title="statement not covered" >    this.transitionTo(</span>
      location,
<span class="fstat-no" title="function not covered" >      function (r</span>oute) {
<span class="cstat-no" title="statement not covered" >        replaceHash(route.fullPath);</span>
        handleScroll(this$1.router, route, fromRoute, false);
        onComplete &amp;&amp; onComplete(route);
      },
      onAbort
...
&nbsp;
  HashHistory.prototype.go = <span class="fstat-no" title="function not covered" >function go (n</span>) {
<span class="cstat-no" title="statement not covered" >    window.history.go(n);</span>
  };
&nbsp;
  HashHistory.prototype.ensureURL = <span class="fstat-no" title="function not covered" >function ensureURL (p</span>ush) {
    var current = <span class="cstat-no" title="statement not covered" >this.current.fullPath;</span>
    if (<span class="cstat-no" title="statement not covered" >getHash() !== current) {</span>
      push ? pushHash(current) : replaceHash(current);
    }
  };
&nbsp;
  HashHistory.prototype.getCurrentLocation = <span class="fstat-no" title="function not covered" >function getCurrentLocation () {</span>
<span class="cstat-no" title="statement not covered" >    return getHash()</span>
  };
&nbsp;
<span class="cstat-no" title="statement not covered" >  return HashHistory;</span>
}(History));
&nbsp;
<span class="fstat-no" title="function not covered" >function checkFallback (b</span>ase) {
  var location = <span class="cstat-no" title="statement not covered" >getLocation(base);</span>
<span class="cstat-no" title="statement not covered" >  if (!/^\/#/.test(location)) {</span>
    window.location.replace(cleanPath(base + '/#' + location));
<span class="cstat-no" title="statement not covered" >    return true</span>
  }
}
&nbsp;
function <span class="fstat-no" title="function not covered" >ensureSlash () {</span>
  var path = <span class="cstat-no" title="statement not covered" >getHash();</span>
...
&nbsp;
function <span class="fstat-no" title="function not covered" >getHash () {</span>
  // We can't use window.location.hash here because it's not
  // consistent across browsers - Firefox will pre-decode it!
  var href = <span class="cstat-no" title="statement not covered" >window.location.href;</span>
  var index = <span class="cstat-no" title="statement not covered" >href.indexOf('#');</span>
  // empty path
...
&nbsp;
  ...
  var <span class="cstat-no" title="statement not covered" >searchIndex = href.indexOf('?');</span>
<span class="cstat-no" title="statement not covered" >  if (searchIndex &lt; 0) {</span>
    var hashIndex = <span class="cstat-no" title="statement not covered" >href.indexOf('#');</span>
    if (hashIndex &gt; -1) {
<span class="cstat-no" title="statement not covered" >      href = decodeURI(href.slice(0, hashIndex)) + href.slice(hashIndex);</span>
    } else { href = decodeURI(href); }
  } else {
<span class="cstat-no" title="statement not covered" >    href = decodeURI(href.slice(0, searchIndex)) + href.slice(searchIndex);</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  return href</span>
}
&nbsp;
function <span class="fstat-no" title="function not covered" >getUrl (p</span>ath) {
  var href = <span class="cstat-no" title="statement not covered" >window.location.href;</span>
  var i = <span class="cstat-no" title="statement not covered" >href.indexOf('#');</span>
  var base = i &gt;= 0 ? href.slice(0, i) : href;
<span class="cstat-no" title="statement not covered" >  return (base + "#" + path)</span>
}
&nbsp;
function <span class="fstat-no" title="function not covered" >pushHash (p</span>ath) {
  if (<span class="cstat-no" title="statement not covered" >supportsPushState) {</span>
...
&nbsp;
function <span class="fstat-no" title="function not covered" >replaceHash (p</span>ath) {
  if (<span class="cstat-no" title="statement not covered" >supportsPushState) {</span>
...
/*  */
&nbsp;
var AbstractHistory = /*@__PURE__*/(<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >function (H</span>istory) {</span>
  function <span class="fstat-no" title="function not covered" >AbstractHistory (r</span>outer, base) {
<span class="cstat-no" title="statement not covered" >    History.call(this, router, base);</span>
    this.stack = [];
    this.index = -1;
  }
...
&nbsp;
  AbstractHistory.prototype.push = <span class="fstat-no" title="function not covered" >function push (l</span>ocation, onComplete, onAbort) {
    var this$1 = <span class="cstat-no" title="statement not covered" >this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.transitionTo(</span>
      location,
<span class="fstat-no" title="function not covered" >      function (r</span>oute) {
<span class="cstat-no" title="statement not covered" >        this$1.stack = this$1.stack.slice(0, this$1.index + 1).concat(route);</span>
        this$1.index++;
        onComplete &amp;&amp; onComplete(route);
      },
      onAbort
...
&nbsp;
  AbstractHistory.prototype.replace = <span class="fstat-no" title="function not covered" >function replace (l</span>ocation, onComplete, onAbort) {
    var this$1 = <span class="cstat-no" title="statement not covered" >this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.transitionTo(</span>
      location,
<span class="fstat-no" title="function not covered" >      function (r</span>oute) {
<span class="cstat-no" title="statement not covered" >        this$1.stack = this$1.stack.slice(0, this$1.index).concat(route);</span>
        onComplete &amp;&amp; onComplete(route);
      },
      onAbort
    );
...
&nbsp;
  AbstractHistory.prototype.go = <span class="fstat-no" title="function not covered" >function go (n</span>) {
    var this$1 = <span class="cstat-no" title="statement not covered" >this;</span>
&nbsp;
    var targetIndex = <span class="cstat-no" title="statement not covered" >this.index + n;</span>
<span class="cstat-no" title="statement not covered" >    if (targetIndex &lt; 0 || targetIndex &gt;= this.stack.length) {</span>
      return
    }
    var route = <span class="cstat-no" title="statement not covered" >this.stack[targetIndex];</span>
<span class="cstat-no" title="statement not covered" >    this.confirmTransition(</span>
      route,
<span class="fstat-no" title="function not covered" >      function () {</span>
<span class="cstat-no" title="statement not covered" >        this$1.index = targetIndex;</span>
        this$1.updateRoute(route);
      },
<span class="fstat-no" title="function not covered" >      function (e</span>rr) {
        if (<span class="cstat-no" title="statement not covered" >isRouterError(err, NavigationFailureType.duplicated)) {</span>
...
&nbsp;
  AbstractHistory.prototype.getCurrentLocation = <span class="fstat-no" title="function not covered" >function getCurrentLocation () {</span>
    var current = <span class="cstat-no" title="statement not covered" >this.stack[this.stack.length - 1];</span>
<span class="cstat-no" title="statement not covered" >    return current ? current.fullPath : '/'</span>
  };
&nbsp;
  AbstractHistory.prototype.ensureURL = <span class="fstat-no" title="function not covered" >function ensureURL () {</span>
    // noop
  };
&nbsp;
<span class="cstat-no" title="statement not covered" >  return AbstractHistory;</span>
}(History));
&nbsp;
/*  */
&nbsp;
&nbsp;
&nbsp;
var VueRouter = <span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >function VueRouter (<span class="cstat-no" title="statement not covered" >o</span>ptions) {</span></span>
...
&nbsp;
  var mode = <span class="cstat-no" title="statement not covered" >options.mode || 'hash';</span>
...
<span class="cstat-no" title="statement not covered" >  switch (mode) {</span>
    case 'history':
<span class="cstat-no" title="statement not covered" >      this.history = new HTML5History(this, options.base);</span>
<span class="cstat-no" title="statement not covered" >      break</span>
    case 'hash':
<span class="cstat-no" title="statement not covered" >      this.history = new HashHistory(this, options.base, this.fallback);</span>
<span class="cstat-no" title="statement not covered" >      break</span>
    case 'abstract':
<span class="cstat-no" title="statement not covered" >      this.history = new AbstractHistory(this, options.base);</span>
<span class="cstat-no" title="statement not covered" >      break</span>
    default:
      if (<span class="cstat-no" title="statement not covered" >process.env.NODE_ENV !== 'production') {</span>
...
&nbsp;
var prototypeAccessors = <span class="cstat-no" title="statement not covered" >{ currentRoute: { configurable: true } };</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >VueRouter.prototype.match = <span class="fstat-no" title="function not covered" >function match (</span></span>
  raw,
  current,
  redirectedFrom
) {
<span class="cstat-no" title="statement not covered" >  return this.matcher.match(raw, current, redirectedFrom)</span>
};
&nbsp;
prototypeAccessors.currentRoute.get = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >  return this.history &amp;&amp; this.history.current</span>
};
&nbsp;
VueRouter.prototype.init = <span class="fstat-no" title="function not covered" >function init (a</span>pp /* Vue component instance */) {
    var this$1 = <span class="cstat-no" title="statement not covered" >this;</span>
&nbsp;
...
&nbsp;
  ...
  app.$once('hook:destroyed', <span class="fstat-no" title="function not covered" >function () {</span>
    // clean out app from this.apps array once destroyed
    var index = <span class="cstat-no" title="statement not covered" >this$1.apps.indexOf(app);</span>
    if (<span class="cstat-no" title="statement not covered" >index &gt; -1) { this$1.apps.splice(index, 1); }</span>
...
&nbsp;
  var history = <span class="cstat-no" title="statement not covered" >this.history;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (history instanceof HTML5History || history instanceof HashHistory) {</span>
    var setupListeners = <span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >      history.setupListeners();</span>
    };
<span class="cstat-no" title="statement not covered" >    history.transitionTo(history.getCurrentLocation(), setupListeners, setupListeners);</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  history.listen(<span class="fstat-no" title="function not covered" >function (r</span>oute) {</span>
<span class="cstat-no" title="statement not covered" >    this$1.apps.forEach(<span class="fstat-no" title="function not covered" >function (a</span>pp) {</span>
<span class="cstat-no" title="statement not covered" >      app._route = route;</span>
    });
  });
};
&nbsp;
VueRouter.prototype.beforeEach = <span class="fstat-no" title="function not covered" >function beforeEach (f</span>n) {
<span class="cstat-no" title="statement not covered" >  return registerHook(this.beforeHooks, fn)</span>
};
&nbsp;
VueRouter.prototype.beforeResolve = <span class="fstat-no" title="function not covered" >function beforeResolve (f</span>n) {
<span class="cstat-no" title="statement not covered" >  return registerHook(this.resolveHooks, fn)</span>
};
&nbsp;
VueRouter.prototype.afterEach = <span class="fstat-no" title="function not covered" >function afterEach (f</span>n) {
<span class="cstat-no" title="statement not covered" >  return registerHook(this.afterHooks, fn)</span>
};
&nbsp;
VueRouter.prototype.onReady = <span class="fstat-no" title="function not covered" >function onReady (c</span>b, errorCb) {
<span class="cstat-no" title="statement not covered" >  this.history.onReady(cb, errorCb);</span>
};
&nbsp;
VueRouter.prototype.onError = <span class="fstat-no" title="function not covered" >function onError (e</span>rrorCb) {
<span class="cstat-no" title="statement not covered" >  this.history.onError(errorCb);</span>
};
&nbsp;
VueRouter.prototype.push = <span class="fstat-no" title="function not covered" >function push (l</span>ocation, onComplete, onAbort) {
    var this$1 = <span class="cstat-no" title="statement not covered" >this;</span>
&nbsp;
  // $flow-disable-line
<span class="cstat-no" title="statement not covered" >  if (!onComplete &amp;&amp; !onAbort &amp;&amp; typeof Promise !== 'undefined') {</span>
<span class="cstat-no" title="statement not covered" >    return new Promise(<span class="fstat-no" title="function not covered" >function (r</span>esolve, reject) {</span>
<span class="cstat-no" title="statement not covered" >      this$1.history.push(location, resolve, reject);</span>
    })
  } else {
<span class="cstat-no" title="statement not covered" >    this.history.push(location, onComplete, onAbort);</span>
  }
};
&nbsp;
VueRouter.prototype.replace = <span class="fstat-no" title="function not covered" >function replace (l</span>ocation, onComplete, onAbort) {
    var this$1 = <span class="cstat-no" title="statement not covered" >this;</span>
&nbsp;
  // $flow-disable-line
<span class="cstat-no" title="statement not covered" >  if (!onComplete &amp;&amp; !onAbort &amp;&amp; typeof Promise !== 'undefined') {</span>
<span class="cstat-no" title="statement not covered" >    return new Promise(<span class="fstat-no" title="function not covered" >function (r</span>esolve, reject) {</span>
<span class="cstat-no" title="statement not covered" >      this$1.history.replace(location, resolve, reject);</span>
    })
  } else {
<span class="cstat-no" title="statement not covered" >    this.history.replace(location, onComplete, onAbort);</span>
  }
};
&nbsp;
VueRouter.prototype.go = <span class="fstat-no" title="function not covered" >function go (n</span>) {
<span class="cstat-no" title="statement not covered" >  this.history.go(n);</span>
};
&nbsp;
VueRouter.prototype.back = <span class="fstat-no" title="function not covered" >function back () {</span>
<span class="cstat-no" title="statement not covered" >  this.go(-1);</span>
};
&nbsp;
VueRouter.prototype.forward = <span class="fstat-no" title="function not covered" >function forward () {</span>
<span class="cstat-no" title="statement not covered" >  this.go(1);</span>
};
&nbsp;
VueRouter.prototype.getMatchedComponents = <span class="fstat-no" title="function not covered" >function getMatchedComponents (t</span>o) {
  var route = <span class="cstat-no" title="statement not covered" >to</span>
    ? to.matched
      ? to
...
<span class="cstat-no" title="statement not covered" >  if (!route) {</span>
  ...
  return [].concat.apply([], route.matched.map(<span class="fstat-no" title="function not covered" >function (m</span>) {
<span class="cstat-no" title="statement not covered" >    return Object.keys(m.components).map(<span class="fstat-no" title="function not covered" >function (k</span>ey) {</span>
<span class="cstat-no" title="statement not covered" >      return m.components[key]</span>
    })
  }))
};
&nbsp;
VueRouter.prototype.resolve = <span class="fstat-no" title="function not covered" >function resolve (</span>
  to,
  current,
  append
) {
  current = current || this.history.current;
  var location = <span class="cstat-no" title="statement not covered" >normalizeLocation(</span>
    to,
    current,
    append,
    this
  );
  var route = <span class="cstat-no" title="statement not covered" >this.match(location, current);</span>
  var fullPath = <span class="cstat-no" title="statement not covered" >route.redirectedFrom || route.fullPath;</span>
...
&nbsp;
VueRouter.prototype.addRoutes = <span class="fstat-no" title="function not covered" >function addRoutes (r</span>outes) {
<span class="cstat-no" title="statement not covered" >  this.matcher.addRoutes(routes);</span>
...
&nbsp;
function <span class="fstat-no" title="function not covered" >registerHook (l</span>ist, fn) {
  list.push(fn);
<span class="cstat-no" title="statement not covered" >  return <span class="fstat-no" title="function not covered" >function () {</span></span>
    var i = <span class="cstat-no" title="statement not covered" >list.indexOf(fn);</span>
    if (<span class="cstat-no" title="statement not covered" >i &gt; -1) { list.splice(i, 1); }</span>
  }
}
&nbsp;
<span class="fstat-no" title="function not covered" >function createHref (b</span>ase, fullPath, mode) {
  var path = mode === <span class="cstat-no" title="statement not covered" >'hash' ? '#' + fullPath : fullPath;</span>
<span class="cstat-no" title="statement not covered" >  return base ? cleanPath(base + '/' + path) : path</span>
}
&nbsp;
...
&nbsp;
export default <span class="cstat-no" title="statement not covered" >VueRouter;</span>
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Mon Jul 20 2020 16:42:21 GMT+0800 (GMT+08:00)
            </div>
        </div>
